...
explanations. What would settle it is an independent implementation rather than
an independent run of ours; the code, including both schemes and both boundary
conventions, is available~\cite{repo}.
